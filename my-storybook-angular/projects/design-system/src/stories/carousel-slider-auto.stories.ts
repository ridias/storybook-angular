...
import { CarouselSliderAutoComponent } from "../lib/components/carousels/carousel-slider-auto/carousel-slider-auto.component";
...
const meta: Meta<CarouselSliderAutoComponent> = {
    title: 'Example/Carousels/CarouselSliderAuto',
    component: CarouselSliderAutoComponent,
    ...
    argTypes: {
        ...
        secondsNextSlide: {
            description: "Number of seconds to the next slide",
            type: "number",
...
export default meta;
type Story = StoryObj<CarouselSliderAutoComponent>;
...
export const CarouselSliderDefault: Story = {
    ...
    render: (args) => ({
        props: args,
        template: `
            <app-carousel-slider-auto [sliders]="sliders"
