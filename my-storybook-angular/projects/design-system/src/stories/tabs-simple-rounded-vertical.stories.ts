...
import { TabsSimpleRoundedVerticalComponent } from "../lib/components/tabs/tabs-simple-rounded-vertical/tabs-simple-rounded-vertical.component";
...
const meta: Meta<TabsSimpleRoundedVerticalComponent> = {
    title: 'Example/Tabs Menu/TabsSimpleRoundedVertical',
    component: TabsSimpleRoundedVerticalComponent,
    tags: ['autodocs'],
    argTypes: {
        tabs: {
...
export default meta;
type Story = StoryObj<TabsSimpleRoundedVerticalComponent>;
...
export const TabsSimplePrimary: Story = {
    ...
    render: (args) => ({
        props: args,
        template: `
        <app-tabs-simple-rounded-vertical
            ${argsToTemplate(args)}>
