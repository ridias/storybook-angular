...
import { PillsSimpleComponent } from "../lib/components/pills/pills-simple/pills-simple.component";
...
const meta: Meta<PillsSimpleComponent> = {
    title: 'Example/Pills Menu/PillsSimple',
    component: PillsSimpleComponent,
    tags: ['autodocs'],
    decorators: [
        moduleMetadata({
            imports: [
...
export default meta;
type Story = StoryObj<PillsSimpleComponent>;

export const PillsSimpleDefault: Story = {
    args: {
        pills: items,
        idPillActivated: 1,
        pillClicked(e) {
