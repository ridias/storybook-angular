...
import { TabsIconsRoundedComponent } from "../lib/components/tabs/tabs-icons-rounded/tabs-icons-rounded.component";
...
const meta: Meta<TabsIconsRoundedComponent> = {
    title: 'Example/Tabs Menu/TabsIconsRounded',
    component: TabsIconsRoundedComponent,
    tags: ['autodocs'],
    argTypes: {
        tabs: {
...
export default meta;
type Story = StoryObj<TabsIconsRoundedComponent>;
