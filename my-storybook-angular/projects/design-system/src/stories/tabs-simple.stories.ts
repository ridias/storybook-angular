...
import { TabsSimpleComponent } from "../lib/components/tabs/tabs-simple/tabs-simple.component";
...
const meta: Meta<TabsSimpleComponent> = {
    title: 'Example/Tabs Menu/TabsSimple',
    component: TabsSimpleComponent,
    tags: ['autodocs'],
    argTypes: {
        tabs: {
...
export default meta;
type Story = StoryObj<TabsSimpleComponent>;
