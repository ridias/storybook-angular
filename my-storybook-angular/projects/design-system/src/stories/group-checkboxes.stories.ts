...
import { GroupCheckboxesComponent } from "../lib/components/checkboxes/group-checkboxes/group-checkboxes.component";
...
const meta: Meta<GroupCheckboxesComponent> = {
    title: 'Example/Checkboxes/GroupCheckboxes',
    component: GroupCheckboxesComponent,
    tags: ['autodocs'],
    decorators: [
        moduleMetadata({
            imports: [
...
export default meta;
type Story = StoryObj<GroupCheckboxesComponent>;

export const GroupCheckboxesDefault: Story = {
    args: {
        checkboxes: items,
    ...
    render: (args) => ({
        props: args,
        template: `
            <app-group-checkboxes ${argsToTemplate(args)}>
