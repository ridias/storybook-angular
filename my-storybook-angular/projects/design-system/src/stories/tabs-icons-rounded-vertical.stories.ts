...
import { TabsIconsRoundedVerticalComponent } from "../lib/components/tabs/tabs-icons-rounded-vertical/tabs-icons-rounded-vertical.component";
...
const meta: Meta<TabsIconsRoundedVerticalComponent> = {
    title: 'Example/Tabs Menu/TabsIconsRoundedVertical',
    component: TabsIconsRoundedVerticalComponent,
    tags: ['autodocs'],
    argTypes: {
        tabs: {
...
export default meta;
type Story = StoryObj<TabsIconsRoundedVerticalComponent>;
...
export const TabsSimplePrimary: Story = {
    ...
    render: (args) => ({
        props: args,
        template: `
        <app-tabs-icons-rounded-vertical
            ${argsToTemplate(args)}>
