...
import { PillsRoundedComponent } from "../lib/components/pills/pills-rounded/pills-rounded.component";
...
const meta: Meta<PillsRoundedComponent> = {
    title: 'Example/Pills Menu/PillsRounded',
    component: PillsRoundedComponent,
    tags: ['autodocs'],
    decorators: [
        moduleMetadata({
            imports: [
...
export default meta;
type Story = StoryObj<PillsRoundedComponent>;

export const PillsRoundedDefault: Story = {
    args: {
        pills: items,
        idPillActivated: 1,
        pillClicked(e) {
