...
import { TabsIconsComponent } from "../lib/components/tabs/tabs-icons/tabs-icons.component";
...
const meta: Meta<TabsIconsComponent> = {
    title: 'Example/Tabs Menu/TabsIcons',
    component: TabsIconsComponent,
    tags: ['autodocs'],
    argTypes: {
        tabs: {
...
export default meta;
type Story = StoryObj<TabsIconsComponent>;
