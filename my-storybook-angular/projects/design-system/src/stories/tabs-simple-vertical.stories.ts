...
import { TabsSimpleVerticalComponent } from "../lib/components/tabs/tabs-simple-vertical/tabs-simple-vertical.component";
...
const meta: Meta<TabsSimpleVerticalComponent> = {
    title: 'Example/Tabs Menu/TabsSimpleVertical',
    component: TabsSimpleVerticalComponent,
    tags: ['autodocs'],
    argTypes: {
        tabs: {
...
export default meta;
type Story = StoryObj<TabsSimpleVerticalComponent>;
