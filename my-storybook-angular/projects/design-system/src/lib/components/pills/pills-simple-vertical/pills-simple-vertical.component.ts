...
@Component({
    selector: 'app-pills-simple-vertical',
    templateUrl: './pills-simple-vertical.component.html',
    styleUrls: ['./pills-simple-vertical.component.scss']
})

export class PillsSimpleVerticalComponent implements OnInit {
