...
@Component({
    selector: 'app-pills-rounded',
    templateUrl: './pills-rounded.component.html',
    styleUrls: ['./pills-rounded.component.scss']
})

export class PillsRoundedComponent implements OnInit {
