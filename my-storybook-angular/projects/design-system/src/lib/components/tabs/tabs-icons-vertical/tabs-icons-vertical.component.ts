...
@Component({
    selector: 'app-tabs-icons-vertical',
    templateUrl: './tabs-icons-vertical.component.html',
    styleUrls: ['./tabs-icons-vertical.component.scss']
})

export class TabsIconsVerticalComponent implements OnInit {
