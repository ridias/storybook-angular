...
@Component({
    selector: 'app-tabs-icons-rounded',
    templateUrl: './tabs-icons-rounded.component.html',
    styleUrls: ['./tabs-icons-rounded.component.scss']
})

export class TabsIconsRoundedComponent implements OnInit {
