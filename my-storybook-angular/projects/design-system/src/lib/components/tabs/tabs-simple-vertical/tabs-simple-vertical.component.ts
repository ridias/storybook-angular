...
@Component({
    selector: 'app-tabs-simple-vertical',
    templateUrl: './tabs-simple-vertical.component.html',
    styleUrls: ['./tabs-simple-vertical.component.scss']
})

export class TabsSimpleVerticalComponent implements OnInit {
