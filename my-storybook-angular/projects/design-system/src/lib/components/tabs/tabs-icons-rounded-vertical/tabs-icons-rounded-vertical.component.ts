...
@Component({
    selector: 'app-tabs-icons-rounded-vertical',
    templateUrl: './tabs-icons-rounded-vertical.component.html',
    styleUrls: ['./tabs-icons-rounded-vertical.component.scss']
})

export class TabsIconsRoundedVerticalComponent implements OnInit {
